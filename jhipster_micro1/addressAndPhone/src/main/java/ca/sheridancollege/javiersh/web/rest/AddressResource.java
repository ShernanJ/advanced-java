...
/**
 * REST controller for managing {@link ca.sheridancollege.javiersh.domain.Address}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class AddressResource {
    ...
    private static final String ENTITY_NAME = "addressAndPhoneAddress";
        ...
        Optional<Address> result = addressRepository
            ...
            .map(existingAddress -> {
                ...
                if (address.getProvinceOrState() != null) {
                    existingAddress.setProvinceOrState(address.getProvinceOrState());
                }
