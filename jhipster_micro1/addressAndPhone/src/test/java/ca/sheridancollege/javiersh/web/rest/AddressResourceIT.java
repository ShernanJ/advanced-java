...
import ca.sheridancollege.javiersh.domain.Address;
import ca.sheridancollege.javiersh.repository.AddressRepository;
...
class AddressResourceIT {
    ...
    void getAllAddresses() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.[*].provinceOrState").value(hasItem(DEFAULT_PROVINCE_OR_STATE)))
    ...
    void getAddress() throws Exception {
        ...
        restAddressMockMvc
            ...
            .andExpect(jsonPath("$.provinceOrState").value(DEFAULT_PROVINCE_OR_STATE))
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.city(UPDATED_CITY).provinceOrState(UPDATED_PROVINCE_OR_STATE).country(UPDATED_COUNTRY);
